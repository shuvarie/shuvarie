...
Milestone M7.1 ships; the M7.2 catalog milestone ships; M7.3 multi-agent orchestration ships; M7.4 context loading ships; M7.5 history search ships; M7.6 semantic search ships; the rest remain future work.
